...
* [Facebook folly PC](https://github.com/facebook/folly/blob/master/folly/ProducerConsumerQueue.h) ⭐ 30,532 | 🐛 466 | 🌐 C++ | 📅 2026-09-07
* [concurrentqueue](https://github.com/cameron314/concurrentqueue) ⭐ 12,484 | 🐛 77 | 🌐 C++ | 📅 2026-07-11
...
* [ceres-solver](https://github.com/ceres-solver/ceres-solver) ⭐ 4,555 | 🐛 65 | 🌐 C++ | 📅 2026-08-19
...
* [OctoMap](https://github.com/OctoMap/octomap) ⭐ 2,367 | 🐛 44 | 🌐 C++ | 📅 2026-08-02
...
* [evo - evaluation tool for different trajectory formats](https://github.com/MichaelGrupp/evo) ⭐ 4,313 | 🐛 7 | 🌐 Python | 📅 2026-09-06
...
* [Kimera](https://github.com/MIT-SPARK/Kimera) ⭐ 2,124 | 🐛 2 | 📅 2021-01-30. Available on ROS
...
* [PTAM](https://github.com/Oxford-PTAM/PTAM-GPL) ⭐ 806 | 🐛 17 | 🌐 C++ | 📅 2014-12-03
...
* [LSD-SLAM](https://github.com/tum-vision/lsd_slam) ⭐ 2,725 | 🐛 240 | 🌐 C++ | 📅 2023-03-23. Available on ROS

> LSD-SLAM: Large-Scale Direct Monocular SLAM, J. Engel, T. Schöps, D. Cremers, ECCV '14
> Semi-Dense Visual Odometry for a Monocular Camera, J. Engel, J. Sturm, D. Cremers, ICCV '13

* [ORB-SLAM](https://github.com/raulmur/ORB_SLAM) ⭐ 1,633 | 🐛 121 | 🌐 C++ | 📅 2022-09-18. Available on ROS
...
* [Nister's Five Point Algorithm for Essential Matrix estimation, and FAST features, with a KLT tracker](https://github.com/avisingh599/mono-vo) ⭐ 822 | 🐛 15 | 🌐 C++ | 📅 2017-04-18
...
* [Dense Visual SLAM for RGB-D Cameras](https://github.com/tum-vision/dvo_slam) ⭐ 669 | 🐛 53 | 🌐 C++ | 📅 2016-09-21. Available on ROS
...
* [RTAB MAP - Real-Time Appearance-Based Mapping](https://github.com/introlab/rtabmap) ⭐ 3,987 | 🐛 581 | 🌐 C++ | 📅 2026-08-31. Available on ROS
...
* [ORB2-SLAM](https://github.com/raulmur/ORB_SLAM2) ⭐ 10,233 | 🐛 806 | 🌐 C++ | 📅 2024-05-15. Available on ROS
...
* [Google's cartographer](https://github.com/googlecartographer/cartographer) ⭐ 7,958 | 🐛 240 | 🌐 C++ | 📅 2024-01-05. Available on ROS

## Other open source projects

[DynaSLAM](https://github.com/BertaBescos/DynaSLAM) ⭐ 946 | 🐛 64 | 🌐 C++ | 📅 2020-03-18 A SLAM system robust in dynamic environments for monocular, stereo and RGB-D setups
